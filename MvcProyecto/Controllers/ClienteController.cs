...
namespace MvcProyecto.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public ClienteController(MvcProyectoContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,CedulaJuridica,PaginaWeb,DireccionFisica,NumeroTelefono,Sector")] Cliente cliente)
        {
            if (id != cliente.ID)
            {
                return NotFound();
